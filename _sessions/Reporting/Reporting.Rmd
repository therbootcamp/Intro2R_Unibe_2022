...
<ul>
  <li class="m1"><span>Paths can be specified in <high>Preferences - RMarkdown</high>.</span></li>
  <li class="m2"><span>Check that 'Evaluate chunks in directory' is set to <high>Project</high>.</span></li>
</ul>
...
<p align = "center">
  <img src="image/settings_project.png" height=480px>
</p>
...
<h1>`r paste0('<a href="', session_url, 'Reporting/Reporting_practical.html">Practical</a>')`</h1>
