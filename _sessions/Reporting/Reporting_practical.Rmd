...
1. In this practical you will create as much of [this html document](https://dwulff.github.io/Intro2R_Unibe_2021/_sessions/Reporting/Reporting_answers.html) as you can! Open the document and keep it open in a separate window as you work through the practical!
...
4. Create a new code chunk by either clicking the "Insert - R" button, or by using the "Command|Ctrl + Option + I"" shortcut on Mac
