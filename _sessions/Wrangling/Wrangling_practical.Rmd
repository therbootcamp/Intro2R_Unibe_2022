...
4. In this practical, you will analyze the `trial_act` data. Using the following template, load both the original and demo data into R and store it as a new object called `trial_act` and `trial_act_demo`.
