...
```{r}
# Filter patients younger than 40
combined %>%
  filter(age < 40)
```
...
Select <i>only</i> patients over `30` in the `'drug'` arm.
...
<h1><a href="https://dwulff.github.io/Intro2R_Unibe_2021/_sessions/Wrangling/Wrangling_practical.html">Practical</a></h1>
