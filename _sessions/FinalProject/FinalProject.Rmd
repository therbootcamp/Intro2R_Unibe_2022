---
title: "Final Project for 2 ECTS"
...
<p align="center">
<img width="100%" src="image/physician.jpeg" margin=0><br>
<font style="font-size:10px">adapted from [https://unsplash.com/](https://unsplash.com/s/photos/physician)</font>
</p>
...
2. Document your 3 central insights out of this dataset. Describe what the insights are with your own words and document them with figures, statistics and tables produced with R code in your Markdown file `FinalReport.html`.   

3. Generate a new file with `File - R Markdown - Presentation` (with the default: HTML Ioslides). Save this file to your `TheRBootcamp` folder `FinalPresentation.Rmd`. Alternatively you can check out a template we provide for you in your `TheRBoocamp` project folder `4_Markdown` called `Slide_Demo.Rmd`

4. Prepare a 15 minute presentation documenting your approach to the Document and your 3 central insights out of this dataset. Describe what the insights are with your own words and document them with figures, statistics and tables produced with R code in your Markdown file.
